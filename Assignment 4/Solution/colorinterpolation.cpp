...
namespace
{
    ...
    */
                                     ...
                                     const float t)
    {
        ...
        int start;
        float t1;
        int diff = (int)abs(ColorA.h - ColorB.h) % 360;
        if (diff > 180){
          diff = 360 - diff;
        }
        ...
        if(abs(ColorA.h - ColorB.h)<180){
          if ((ColorA.h - ColorB.h)<0){
            InterpolatedColor.h = ColorA.h + t*diff;

          }else{
            InterpolatedColor.h = ColorB.h + (1-t)*diff;
          }

        }else{
          if((ColorA.h - ColorB.h)<0){
            float tmp = ColorB.h + (1-t)*diff;
            InterpolatedColor.h = (int)tmp % 360;


          }else{
            float tmp = ColorA.h + t*diff;
            InterpolatedColor.h = (int)tmp % 360;
        ...
        // float CW_angle_fromA = ColorA.h - ColorB.h;
        // if (CW_angle_fromA < 0){
        //   CW_angle_fromA = CW_angle_fromA + 360;
        // }
        //
        // float CCW_angle_fromA = ColorB.h - ColorA.h;
        //
        // if (CCW_angle_fromA < 0){
        //   CCW_angle_fromA = CCW_angle_fromA + 360;
        // }
        //
        // if(CCW_angle_fromA > CW_angle_fromA){
        //   start = ColorA.h;
        //   t1 = t;
        // }
        // else{
        ...
        // }
        //
        // float temp = start + t1*diff;
        //
        // InterpolatedColor.h = (int)temp%360;
        ...
        // }
        //
        // int maxCCW = higherHue - lowerHue;  // DIFFERENCE GOING ANTI CLOCKWISE
        // int maxCW = (lowerHue+360) - higherHue; // DIFFERENCE GOING CLOCKWISE


        // if((ColorA.h - ColorB.h) > 0){
        //   CW_fromA = 1;     // gives us minur or plus
        //   start = ColorB.h;
        //   t1 = 1-t;
        //   cerr << 1 << endl;
        // }
        ...
        // int CCW_fromA = 0;
        //
        // if(abs(ColorA.h - ColorB.h) > (ColorA.h +360) + ColorB.h){
        //   CW_fromA = 1;
        //   start = ColorB.h;
        //   t1 = t-1;
        // }
        ...
        // cerr << "ColorA: " << ColorA.h << endl << "ColorB: " << ColorB.h << endl;
        // cerr << "diff: " << diff << endl;
        //
        // int ah = ColorA.h;
        // float temp;
        // int res;
        //
        // if(diff==maxCCW && ColorA.h < ColorB.h){
        //   cerr << 1 << endl;
        //   InterpolatedColor.h = (ColorA.h + t*diff);
        // }
        // else if(diff!=maxCCW && ColorA.h > ColorB.h){
        //   InterpolatedColor.h = (ColorA.h - t*diff);
        //   cerr << 2 << endl;
        // }
        // else if(diff == maxCW && ColorA.h > ColorB.h){
        //   cerr << 3 << endl;
        //   temp = (ah + t*diff);
        //   res = (int)temp;
        //   InterpolatedColor.h = res%360;
        // }
        // else{
        //   cerr << 4 << endl;
        //   temp = (ah - t*diff);
        ...
        // int maxCW = (lowerHue+360) - higherHue;
        // int hDistance;
        // int start = lowerHue;
        //
        // if (maxCCW > maxCW){
        ...
        // }
        // t1 = t;
        // InterpolatedColor.h = (start + t1*hDistance)%360;
        ...
        // int start;
        //
        // if (maxCCW > maxCW){  // leads to conunterclockwise interpolation
        //   start = lowerHue;
        //
        // }
        // else{ // clockwise interpolation
        //   start = higherHue;
        //
        // }
        // t1 = t;
